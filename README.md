...
Welcome to Spiral Dance! Enter a number to navigate a recursive spiral of transformations. Your goal? Land precisely on a hidden value. Crack the pattern, and the flag is yours. Let the dance begin! 🕺🏻
...
### SIGABA (500 pts)  
Okay, I see that you managed to crack Enigma last time, but this time, I’ve got SIGABA for you—the U.S. encryption algorithm used during WWII. Unlike Enigma, SIGABA was never broken. Let’s see how you handle it!
...
### Warmup (500 pts)  
In the past few days, I’ve noticed unusual changes on an employee’s computer. Fortunately, I found a pcap file that might provide some clues about what’s happening!
...
This is a collaborative effort from our team, and we hope you find this challenge amusing! It's our first experience creating an AI challenge, so please share your thoughts with us! 😊  
